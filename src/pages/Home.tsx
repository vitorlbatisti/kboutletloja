        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="relative aspect-[16/10] md:aspect-square rounded-[2.5rem] overflow-hidden group"
            >
              <img 
              ...
              <div className="absolute bottom-10 left-10">
                <h3 className="text-3xl md:text-5xl font-bebas text-white mb-2">ESSENCIAIS</h3>
                <p className="text-white/60 text-sm font-bold uppercase tracking-widest">Coleção 2024</p>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 gap-8">
              <motion.div 
                ...
                className="relative aspect-[16/10] rounded-[2.5rem] overflow-hidden group"
              >
                <img 
                  src="https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?q=80&w=1974&auto=format&fit=crop" 
                  alt="Lifestyle 2" 
                ...
                <div className="absolute bottom-8 left-8">
                  <h3 className="text-2xl md:text-4xl font-bebas text-white mb-1">STREETWEAR</h3>
                  <p className="text-white/60 text-xs font-bold uppercase tracking-widest">Premium Quality</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" />
                <div className="absolute bottom-8 left-8">
                  <h3 className="text-2xl md:text-4xl font-bebas text-white mb-1">OUTLET</h3>
                  <p className="text-white/60 text-xs font-bold uppercase tracking-widest">Ofertas Exclusivas</p>
                </div>
              </motion.div>
            </div>
          </div>

      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="md:col-span-2">
            <Link to="/" className="text-3xl font-black tracking-tighter text-white mb-8 block font-bebas">
              KB<span className="text-gray-base">OUTLET</span>
            </Link>
              ...
              {['Início', 'Catálogo', 'Novidades', 'Outlet'].map((item) => (
                <li key={item}>
                  <Link 
                    ...
                    className="text-muted hover:text-white transition-colors text-sm font-bold uppercase tracking-widest flex items-center group"
                  >
                    {item}
          ...
          <div>
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4 group cursor-pointer">
                <div className="w-10 h-10 rounded-xl bg-secondary flex items-center justify-center text-muted group-hover:text-white transition-colors border border-white/5">
                  <Phone size={18} />
                </div>
                <div>
                  <p className="text-[10px] text-gray-base font-bold uppercase tracking-widest mb-1">WhatsApp</p>
                  <p className="text-sm text-muted font-bold">+55 (49) 9 9818-9601</p>
                </div>
              </li>
              <li className="flex items-start gap-4 group cursor-pointer">
                <div className="w-10 h-10 rounded-xl bg-secondary flex items-center justify-center text-muted group-hover:text-white transition-colors border border-white/5">
                ...
                <div>
                  <p className="text-[10px] text-gray-base font-bold uppercase tracking-widest mb-1">Localização</p>
                  <p className="text-sm text-muted font-bold">Novo Horizonte, SC</p>
                  <p className="text-[10px] text-muted font-medium">CEP: 89998-000</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-16 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <p className="text-gray-base text-[10px] font-bold uppercase tracking-[0.2em]">
            ...
            <div className="flex gap-6">
              <Link 
                ...
                className="text-zinc-900 hover:text-muted text-[10px] font-bold uppercase tracking-[0.2em] transition-colors"
              >
                Acesso Restrito
              </Link>
            </div>
